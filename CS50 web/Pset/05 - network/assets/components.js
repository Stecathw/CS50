...
export function HeartButton (props) {
  ...
  function HandleClick (e) {
    e.preventDefault()
    if (props.loggedUser === "visitor") {alert("Please register or log in.")}
    else {
...
export function Post (props) {
  ...
  return (
        <div className={postClass}>
            ...
            <HeartButton post={post} loggedUser={loggedUser}/>
        </div>
  )
}
...
export function FollowButton (props) {
  ...
  const HandleClick = (e) => {
    e.preventDefault()
    if (loggedUser === "visitor") {alert("Please register or log in.")}
    else {
